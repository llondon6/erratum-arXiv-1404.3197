...
%
\paragraph*{Other Comments --} The equation just prior to Equation (32) is missing a factor of 2 in its exponent and thus should read $\cw^2_{lmn} = |\cw_{lmn}|^2 \, e^{-2\varphi_{lmn}}$. The first line of Equation (32) should contain $\cw^2_{lmn}$ not $\cw^2_{nlm}$. In \eqns{eq:fit_fun_A220}{eq:fit_fun_A550}, the authors choose to omit the $(l,m,n) \in \{ (5,4,0), \; (2,2,2) \}$ \qnm{s} due to data quality concerns.
